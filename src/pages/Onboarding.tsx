  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const contractorData: any = {
        ...
        business_address: existingContractor
          ? businessAddress
          : formData.address,
      ...
      if (
        currentStep === OnboardingSteps.PRICING &&
    ...
    try {
      ...
      if (formData.tier === "pioneer") {
        ...
        if (formData.stripe_customer_id) {
          ...
          const stripeResponse = await supabase.functions.invoke(
          ...
          if (!stripeResponse.data || !stripeResponse.data.clientSecret) {
            console.error(
              "Failed to retrieve client_secret:",
          ...
          console.log(
            "Contact and customer created successfully:",
            contactId,
            customerId,
          );
          ...
          <div className="space-y-6 flex flex-col items-center w-full">
            <div className="text-center space-y-2">
              ...
              <p className="text-[15px] text-[#86868b]">
                This information will be visible to customers when they show
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between pt-6">
                  <Button
                    ...
                    disabled={
                      currentStep === OnboardingSteps.BUSINESS_INFO || loading
                    }
          ...
          <div className="space-y-6 flex flex-col items-center w-full">
            ...
            <div className="bg-white rounded-2xl border border-[#d2d2d7] shadow-sm p-8 min-w-full md:min-w-[80%]">
              <AddPaymentMethod
                ...
                customerId={formData.stripe_customer_id}
