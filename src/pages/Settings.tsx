...
const Settings = () => {
  ...
  const {
    data: aiInstructions,
    isLoading: aiInstructionsLoading,
    error: aiInstructionsError,
  } = useQuery({
    ...
    try {
      ...
      const promises = rates.map(async (rate) => {
        if (rate.id) {
          ...
          const { error } = await supabase.from("ai_rates").upsert({
  ...
  const isAdmin =
    contractor?.contact_email === "cairlbrandon@gmail.com" ||
  ...
  const handleSubmitBusinessForm = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const data = Object.fromEntries(
      formData.entries(),
    ) as unknown as BusinessSettingsFormData;
  ...
  const getSectionTitle = () => {
    switch (activeSection) {
      ...
      case "branding":
        return t("Branding");
      case "estimate":
        return t("Estimate Settings");
      case "ai":
        return t("AI Preferences");
      case "categories":
        return t("Service Categories");
      case "webhooks":
        return t("Webhooks");
      case "translation":
        ...
        return (
          <div className="space-y-4 pt-4">
            ...
            <form
              ...
              className="space-y-2 pt-6 flex flex-col gap-3"
            >
              <Input
              ...
              <div className="form-group mb-0 relative group">
                ...
                <label
                  ...
                  className={`absolute left-3 transition-all duration-200 ${
                    businessAddress
                      ? "-top-[7px] text-xs bg-white px-[4px]"
                      : "top-[22px] text-sm bg-transparent"
        ...
        return (
          <div className="space-y-6">
            ...
            {aiRatesLoading ? (
              ...
              <AIRateForm rates={aiRates || []} onSave={saveRates} />
            )}
          </div>
        );
      case "categories":
        ...
        <div className="flex gap-6">
          <div className="w-80 space-y-2 flex-shrink-0 max-h-[80vh] overflow-y-auto scrollbar-hide">
            ...
            <SettingsMenuItem
              ...
              description={t(
                "Configure how AI generates estimates and manages rates",
              )}
              handleSectionChange={(section) => handleSectionChange(section)}
            ...
            <SettingsMenuItem
              ...
              description={t(
                "Configure your language preferences and translations",
              )}
              handleSectionChange={(section) => handleSectionChange(section)}
