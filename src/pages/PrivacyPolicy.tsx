      ...
      <div className="mt-12 text-gray-700 text-base leading-relaxed">
        ...
        <section>
          ...
          <p>
            ...
            connect customers with contractors. This Privacy Policy explains how
            we collect, use, and protect your personal data in compliance with
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 px-5 text-[15px] text-muted-foreground">
            ...
            <li>
              <strong>Project Details:</strong> Information users provide about
            ...
            <li>
              ...
              number and SMS opt-in information will not be sold or shared with
              third parties.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 text-[15px] text-muted-foreground px-5">
            ...
            <li>
              Providing marketing and promotional offers (via email or SMS, if
              consent is given).
            </li>
            <li>
        ...
        <section>
          <h2 className="text-lg font-semibold leading-none tracking-tight my-4">
            4. Data Sharing with Contractors & Third Parties
          </h2>
          <ul className="list-disc list-inside space-y-2 text-[15px] text-muted-foreground px-5">
            <li>Contractors to provide project estimates and services.</li>
            <li>
              Third-party service providers (e.g., SMS providers, payment
              processors, analytics tools).
            </li>
          </ul>
          <p className="mt-2">
            All third-party providers follow data protection regulations to
            ensure user privacy.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 text-[15px] text-muted-foreground px-5">
            <li>
              <strong>Performance of a contract:</strong> To provide estimates
              and connect users with contractors.
            </li>
            <li>
            ...
            <li>
              <strong>User consent:</strong> For marketing and SMS
              communications.
            </li>
          </ul>
          <p className="mt-2">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 text-[15px] text-muted-foreground px-5">
            <li>
              <strong>Encryption & Secure Storage:</strong> All personal and
              payment data is encrypted and stored securely.
            </li>
            <li>
              <strong>Retention Period:</strong> User data is stored
              indefinitely unless a deletion request is made. SMS opt-in records
              are retained for compliance purposes even after unsubscribing.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            If you are a resident of the EU or EEA, you have the following
          ...
          <ul className="list-disc list-inside space-y-2 mt-2 text-[15px] text-muted-foreground px-5">
            ...
            <li>
              <strong>Right to rectify:</strong> Correct inaccurate or
              incomplete data.
            </li>
            <li>
              <strong>Right to erase:</strong> Request deletion of your data.
            </li>
            <li>
              <strong>Right to object:</strong> Opt out of certain data
              processing (e.g., marketing or SMS).
            </li>
            <li>
          ...
          <p className="mt-2">
            To stop receiving SMS messages, reply <strong>STOP</strong> at any
            time. For assistance, reply <strong>HELP</strong>.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            As we may use third-party services outside the EU/EEA, we ensure all
            data transfers comply with GDPR through Standard Contractual Clauses
            (SCCs) or other legal safeguards.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            will be posted on this page. Users are encouraged to review the
            policy periodically.
          </p>
        </section>
      </div>
