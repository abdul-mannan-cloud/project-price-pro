...
export const getTemplateStyles = (templateStyle: string = 'modern') => {
  const baseStyles = {
    ...
    contactLink: "flex items-center gap-2 text-sm text-gray-600 hover:text-gray-900",
    ...
    table: "w-full",
    tableHeader: "text-left py-2 px-4 bg-gray-50 text-sm font-medium text-gray-600",
  ...
  switch (templateStyle) {
    case 'classic':
      return {
        ...
        tableHeader: "text-left py-3 px-4 bg-gray-100 text-sm font-bold border-b border-gray-200",
    ...
    case 'minimal':
      return {
        ...baseStyles,
        card: "p-8 bg-white",
        tableHeader: "text-left py-2 px-4 border-b-2 border-gray-200 text-sm font-medium",
        tableRow: "border-b border-gray-100",
    ...
    case 'bold':
      return {
        ...
        tableHeader: "text-left py-3 px-4 bg-gray-800 text-sm font-bold text-white",
    ...
    case 'excel':
      return {
        ...
        tableHeader: "text-left py-2 px-3 bg-gray-100 text-xs font-bold border border-gray-300",
