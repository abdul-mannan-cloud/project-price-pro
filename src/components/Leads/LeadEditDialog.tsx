...
export const LeadEditDialog = ({ lead, isOpen, onClose, onLeadUpdated }) => {
  ...
  const handleLineItemChange = (
    ...
    const newGroups = JSON.parse(
      JSON.stringify(editedLead.estimate_data.groups),
    );
    const item =
            ...
            {editedLead.estimate_data?.groups && (
              <div className="space-y-6">
                      ...
                      >
                        <div className="flex justify-between items-center">
                          ...
                          <Button
                            ...
                            variant="outline"
                            onClick={() =>
                              handleAddLineItem(groupIndex, subgroupIndex)
                            }
                            className="h-8 px-2"
                          >
                ...
                <div className="text-right text-lg font-bold">
                  Total Estimate: $
                  {editedLead.estimate_data.totalCost.toFixed(2)}
                </div>
              </div>
            )}
          </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              lead and all associated estimate data.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
