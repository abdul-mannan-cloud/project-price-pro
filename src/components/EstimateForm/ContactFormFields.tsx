...
export const ContactFormFields = ({
  ...
  const validateFields = () => {
    ...
    if (!validatePhone(formData.phone))
      newErrors.phone = "Enter a real phone number with area code.";
    if (!validateFullAddress(formData.address))
      newErrors.address =
        "Please enter full address (Street, City, State, Zip).";
    ...
    <div className="space-y-6">
      ...
      <div className="form-group relative">
        ...
        <PhoneInput
          ...
          className={cn("form-input", "h-12 px-4 pt-2")}
        />
        <label className="absolute -top-2.5 left-2 text-sm bg-background px-1 text-muted-foreground">
          Phone Number
        </label>
