        ...
        <div className="space-y-6">
            ...
            <div className="space-y-2">
                <label className="text-gray-700 text-sm font-medium">
                    Input total {question.unit === "SF" ? "flooring SF" :
                    question.unit === "LF" ? "linear footage" :
                        "measurement"}
                </label>
            ...
            {question.camera_option && (
                <p className="text-center text-sm text-gray-500 mt-4">
                    Capture project measurements with a single photo per area—make sure the entire space is visible in each shot.<br />
                    <span className="text-primary">Avoid multiple photos of the same area.</span>
                </p>
            )}
