...
export const CategoryGrid = ({
  ...
  const handleContinue = () => {
    ...
    const sortedSelectedCategories = Array.from(selectedCategories)
      .sort((a, b) => {
          ...
          <div className="flex flex-col gap-2">
            {selectedCategories.size > 0 && (
              <div className="text-sm text-muted-foreground">
                Selected categories: {Array.from(selectedCategories).map(id => 
            ...
            <Button 
              ...
              size="lg"
            >
              Continue with {selectedCategories.size} {selectedCategories.size === 1 ? 'category' : 'categories'}
            </Button>
          </div>
        </div>
      </div>
