      ...
      <div className="space-y-4">
        {groups.map((group, index) => (
          <div key={index} className={cn(styles.section, "pb-4")}>
            <h3
              className={cn(styles.groupTitle, "text-base font-semibold mb-2")}
            >
              {group.name}
            </h3>
            {group.description && (
            ...
            <table className={styles.table}>
              <thead>
                <tr>
                  ...
                  <th className={cn(styles.tableHeader, "w-[35%]")}>
                    Description
                  </th>
                  <th className={cn(styles.tableHeader, "w-[7%] text-right")}>
                    Qty
                  </th>
                  <th className={cn(styles.tableHeader, "w-[7%] text-right")}>
                    Price
                  </th>
                  <th className={cn(styles.tableHeader, "w-[6%] text-right")}>
                    Total
                  </th>
                </tr>
              </thead>
                  ...
                  <React.Fragment key={`subgroup-${subgroupIndex}`}>
                    {subgroup.items?.map((item, itemIndex) => (
                      ...
                      >
                        ...
                        <td
                          className={cn(styles.tableCell, "w-[7%] text-right")}
                        >
                          {isLoading ? (
