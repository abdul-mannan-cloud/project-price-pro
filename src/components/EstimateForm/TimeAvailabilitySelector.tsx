...
export const TimeAvailabilitySelector = ({
  onChange,
}: TimeAvailabilityProps) => {
  const [flexibility, setFlexibility] = useState<
    "on_date" | "before_date" | "flexible"
  >("flexible");
  ...
  const handleFlexibilityChange = (
    value: "on_date" | "before_date" | "flexible",
  ) => {
  ...
  const handleTimeOfDayChange = (
    value: "morning" | "midday" | "afternoon" | "evening",
  ) => {
    setTimeOfDay(value);
    onChange({
      flexibility,
  ...
  const handleNeedSpecificTimeChange = (
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
              ...
              >
                <div className="flex flex-col items-center">
                  <svg
                    className="w-6 h-6 text-navy-800 mb-2"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
